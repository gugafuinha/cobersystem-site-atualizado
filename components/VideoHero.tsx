          ...
          <div className="max-w-3xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 border border-white/20 col-span-2 md:col-span-1">
                <div className="text-2xl font-bold text-white">Grande SP</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-4 rounded-lg text-lg transition-all transform hover:scale-105 shadow-lg"
              >
