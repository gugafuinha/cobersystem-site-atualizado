...
export const metadata: Metadata = {
  title: "Cobertura Retrátil Guarulhos | Policarbonato com Automação | Cobersystem",
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-xl text-gray-700 mb-8 leading-relaxed">
          A Cobersystem atende Guarulhos com coberturas retráteis em policarbonato. 
          Sistema abre e fecha com automação via Alexa e sensor de chuva. Solicite seu orçamento grátis!
        </p>

        <section className="mb-12 bg-white rounded-lg p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Produtos Disponíveis em Guarulhos</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/produtos/cobertura-policarbonato/em/guarulhos" className="group flex flex-col gap-1 p-4 rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-md transition">
            ...
            <Link href="/produtos/cobertura-retratil/em/guarulhos" className="group flex flex-col gap-1 p-4 rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-md transition">
            ...
            <Link href="/produtos/cobertura-abre-e-fecha/em/guarulhos" className="group flex flex-col gap-1 p-4 rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-md transition">
            ...
            <Link href="/produtos/cobertura-termoacustica/em/guarulhos" className="group flex flex-col gap-1 p-4 rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-md transition">
        ...
        <section className="bg-[#D4AF37] text-black rounded-lg p-12 text-center">
          <h2 className="text-4xl font-bold mb-4">Solicite Seu Orçamento em Guarulhos</h2>
