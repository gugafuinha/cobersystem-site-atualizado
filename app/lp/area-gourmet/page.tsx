...
const WA_HERO  = 'https://wa.me/5511943615079?text=Ol%C3%A1%21+Vim+pelo+Google+e+quero+um+or%C3%A7amento+de+cobertura';
const WA_FINAL = 'https://wa.me/5511943615079?text=Ol%C3%A1%21+Vim+pelo+Google+e+quero+um+or%C3%A7amento+de+cobertura';
...
function trackWaHero() {
  ...
  trackCTAClick('LP Área Gourmet — WhatsApp Hero');
  trackWhatsAppLead({ location: 'lp-gourmet-hero' });
}

function trackWaFinal() {
  trackGoogleAdsConversion(CONVERSION_LABELS.WHATSAPP_CLICK);
  trackCTAClick('LP Área Gourmet — WhatsApp Final');
  trackWhatsAppLead({ location: 'lp-gourmet-final' });
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Cobertura Retrátil para Área Gourmet',
  serviceType: 'Instalação de cobertura retrátil motorizada em área gourmet',
  url: 'https://www.coberturapolicarbonato.com.br/lp/area-gourmet',
  description:
    'Instalação de cobertura retrátil automática para área gourmet em São Paulo. Sensor de chuva, Alexa e garantia de 2 anos. Projeto personalizado e visita técnica gratuita.',
  provider: {
    '@type': 'LocalBusiness',
    name: 'Cobersystem',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quanto custa cobrir uma área gourmet em São Paulo?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O investimento varia conforme o tamanho da área e o tipo de cobertura. Cobertura fixa em policarbonato: R$ 350 a R$ 800 por m². Cobertura retrátil motorizada: R$ 1.500 a R$ 3.000 por m². Para uma área gourmet de 20m², o investimento médio é R$ 30.000 a R$ 60.000 na versão retrátil motorizada. Solicite uma visita técnica gratuita para orçamento personalizado.',
      },
    },
    {
      '@type': 'Question',
      name: 'A cobertura retrátil funciona com churrasqueira a carvão ou a gás?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. A cobertura retrátil é ideal para churrasqueiras pois pode ser aberta durante o uso para ventilação natural, expelindo a fumaça. Quando não está usando ou começa a chover, o sensor fecha automaticamente. Para churrasqueiras a carvão, recomendamos instalar um exaustor ou coifa para evitar acúmulo de fumaça quando a cobertura estiver fechada.',
      },
    },
    {
      '@type': 'Question',
      name: 'Qual o prazo de instalação de cobertura em área gourmet?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'A instalação em si leva de 48 a 72 horas após a aprovação do projeto. A fabricação sob medida leva de 15 a 30 dias. Realizamos a visita técnica gratuita em até 48h após o contato e entregamos o projeto e orçamento em até 48h após a visita.',
      },
    },
  ],
};

export default function LpAreaGourmet() {
  return (
    <>
      <script
        ...
        <section className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <p className="text-blue-300 font-semibold text-sm uppercase tracking-widest mb-4">
              Cobertura para Área Gourmet em São Paulo
            </p>
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-6">
              Sua Área Gourmet Coberta.<br />
              <span className="text-[#D4AF37]">Chove Lá Fora, Festa Aqui Dentro.</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-4 max-w-2xl mx-auto">
              Cobertura retrátil motorizada com sensor de chuva, ventilação automática e integração com Alexa.
            </p>
            <p className="text-gray-400 mb-10">
              Visita técnica gratuita • Projeto 3D personalizado • Instalação em até 72h
            </p>
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              ...
              <div className="bg-gray-50 px-4 py-3 text-center border-t border-gray-100">
                <p className="text-sm text-gray-500 italic">
                  Cobertura retrátil para área gourmet — projeto real Cobersystem SP
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-100 rounded-2xl p-8">
                ...
                <ul className="space-y-3 text-red-700">
                  {[
                    ...
                    'Calor excessivo no verão torna o espaço insuportável',
                    'Fumaça da churrasqueira fica presa quando fecha',
                    'Móveis, fogão a lenha e bancadas danificados',
                    'Área de lazer inutilizável por meses no inverno',
                  ].map((item) => (
              ...
              <div className="bg-green-50 border border-green-100 rounded-2xl p-8">
                ...
                <ul className="space-y-3 text-green-700">
                  {[
                    'Sensor fecha automaticamente ao primeiro sinal de chuva',
                    'Abre para ventilação natural — ideal para fumaça da churrasqueira',
                    'Controle total: aberto para sol, fechado para proteção',
                    'Estrutura em alumínio com garantia de 2 anos',
                    'Espaço disponível 365 dias por ano, em qualquer clima',
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-2 text-sm">
              ...
              {[
                {
                  ...
                  texto: 'Nosso especialista vai até você, mede a área gourmet e apresenta o projeto sem cobrar nada e sem compromisso.',
                },
                {
                  icon: '🎨',
                  titulo: 'Projeto 3D personalizado incluso',
                  texto: 'Você visualiza exatamente como ficará sua área gourmet coberta antes de aprovar qualquer coisa. Sem surpresas.',
                },
                {
                  icon: '🛡️',
                  titulo: '2 anos de garantia na instalação',
                  texto: 'Garantia total: estrutura de alumínio, mecanismo de abertura, motor, automação e policarbonato. Pós-venda incluso.',
                },
        ...
        <section className="py-16 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { num: '1', titulo: 'Visita técnica grátis', texto: 'Agendamos a visita em até 48h. Nosso especialista mede a área gourmet e avalia a melhor solução para o seu projeto.' },
                ...
                { num: '3', titulo: 'Instalação em 48–72h', texto: 'Aprovado o projeto, fabricamos sob medida e instalamos em 48 a 72 horas. Área gourmet pronta para usar.' },
        ...
        <section className="bg-gradient-to-br from-blue-700 to-blue-900 text-white py-20">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <WhatsAppLink
                href="https://wa.me/5511943615079?text=Ol%C3%A1%21+Vim+pelo+Google+e+quero+um+or%C3%A7amento+de+cobertura"
