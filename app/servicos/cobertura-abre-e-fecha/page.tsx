        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:items-start">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <WhatsAppLink href={WHATSAPP_URL} location="hero" serviceSlug="cobertura-abre-e-fecha" className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition">WhatsApp</WhatsAppLink>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-[#D4AF37] text-black rounded-lg p-12 text-center mt-12 mx-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <WhatsAppLink href={WHATSAPP_URL} location="footer-cta" serviceSlug="cobertura-abre-e-fecha" className="inline-block bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-green-700 transition">WhatsApp Agora</WhatsAppLink>
            </div>
          </section>
        </div>
      </main>
