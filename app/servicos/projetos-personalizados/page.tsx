        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <section className="bg-[#D4AF37] text-black rounded-lg p-12 text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <WhatsAppLink href={WHATSAPP_URL} location="footer-cta" serviceSlug="projetos-personalizados" className="inline-block bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-green-700 transition">WhatsApp Agora</WhatsAppLink>
            </div>
          </section>
        </div>
      </main>
