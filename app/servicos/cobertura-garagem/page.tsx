...
const serviceSchema = {
  ...
  '@type': 'Service',
  serviceType: 'Instalação de Cobertura para Garagem',
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <section className="mb-8 max-w-4xl mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <a
                href="/blog/cobertura-garagem-tipos-modelos-precos"
              ...
              >
                ...
                <span className="font-semibold text-gray-900 group-hover:text-blue-700 transition leading-snug block">Cobertura para Garagem: Tipos, Modelos e Preços [2026]</span>
          ...
          <section className="bg-[#D4AF37] text-black rounded-lg p-12 text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <WhatsAppLink href={WHATSAPP_URL} location="footer-cta" serviceSlug="cobertura-garagem" className="inline-block bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-green-700 transition">WhatsApp Agora</WhatsAppLink>
            </div>
          </section>
        </div>
      </main>
